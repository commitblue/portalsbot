...
client.on("interactionCreate", function (interaction) {
    ...
    var found = commands[interaction.commandName];
    if (found) {
        found.execute(interaction);
    }
});
client.on("ready", function () { return __awaiter(void 0, void 0, void 0, function () {
    var commandsData, i, value;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client.guilds.fetch("1025114367991230556")];
            case 1:
                commandsData = _a.sent();
                if (!commandsData) {
                    return [2 /*return*/, console.warn("bad")];
                }
